...
;; BikeRoute -> Boolean
;; checks for exclusive bikeways
(check-expect (exlusive? "Separated Bikeway") true)
(check-expect (exlusive? "Local Street Bikeway") false)
(check-expect (exlusive? "Painted Bike Lane") true)
(check-expect (exlusive? "Painted Shared-Use Lane") false)
