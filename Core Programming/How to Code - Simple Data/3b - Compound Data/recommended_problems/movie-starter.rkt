...
;;          title is the title of movie
;;          budget is the budget of movie
;;          year is the year of movie
...
(check-expect (most-recently-released M1 M2) "Avatar")
(check-expect (most-recently-released M3 M2) "The Avengers")

;(define (most-recently-released m1 m2) "")
